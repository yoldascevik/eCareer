...
{
    public class ApplicationWithdrawnFromJobAdvertEvent : DomainEvent
    {
        public ApplicationWithdrawnFromJobAdvertEvent(JobAdvert jobAdvert, JobApplication jobApplication, ApplicationEventSource eventSource)
        {
