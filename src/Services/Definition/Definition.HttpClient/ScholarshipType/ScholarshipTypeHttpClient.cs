...
namespace Definition.HttpClient.ScholarshipType
{
    public class ScholarshipTypeHttpClient: CareerHttpClient, IScholarshipTypeHttpClient
    {
        ...
        public async Task<ConsistentApiResponse<PagedList<ScholarshipTypeDto>>> GetAsync(PaginationFilter paginationFilter, string version)
        {
        ...
        public async Task<ConsistentApiResponse<ScholarshipTypeDto>> GetByIdAsync(string id, string version)
        {
